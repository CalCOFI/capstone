---
title: "RShiny testing"
author: "Dante Coletta"
date: "2/8/2022"
...
<<<<<<< Updated upstream:scripts/Shiny_testing.Rmd
=======
cast_bottle <- read_csv("data/processed/bottle_and_cast.csv", show_col_types = FALSE)
...
>>>>>>> Stashed changes:Shiny_testing.Rmd
ui<- fluidPage(
  leafletOutput("mymap"),
  h1("Map of Stations off of California Coast"),
  h3("Hovering over each point displays the latitude and longitude of that particular station.")
)
